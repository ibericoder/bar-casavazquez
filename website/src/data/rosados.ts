...
export const rosados: Wine[] = [
    
    {
        ...
        grape: 'Pinot Grigio',
        origin: 'Italien',
        short_description: 'Fruchtig, halbtrocken, frisch und leicht.',
        long_description: 'Allure Pink Pinot Grigio ist ein halbtrockener, fruchtiger Roséwein mit zarten Noten von roten Beeren und einem Hauch von Zitrus. Am Gaumen zeigt er sich frisch und leicht, mit einer angenehmen Restsüße und einem harmonischen Abgang. Ideal als Aperitif oder zu leichten Gerichten.',
        image: null,
        characteristics: 'halbtrocken, fruchtig, frisch',
        available: true
    },
    {
    ...
    },
    {
        ...
        short_description: "Trocken, frisch‑fruchtiger VDP‑Gutsrosé mit knackigen roten & gelben Fruchtnoten.",
        long_description: "Ein eleganter Rosé‑Gutswein aus Laumersheim (Pfalz), cuvée aus Spätburgunder, Dornfelder und Cabernet‑Sorten. Feines kupfer‑/antikrosa, Aromen von Beeren, Zitrus und Kräutern. Am Gaumen saftig, harmonisch und rund – ideal pur oder zu Gegrilltem, Salaten und Antipasti.",
        image: null,
    ...
    },
    {
        ...
        "origin": "Spanien",
        "short_description": "Pale Rosé mit roten Beeren, frischer Säure und cremigem Finish.",
        "long_description": "Helles, attraktives Rosé, geprägt von Aromen roter Früchte wie Erdbeere, Himbeere und Johannisbeere. Am Gaumen frisch, mundfüllend mit feiner Säure und weichem, anhaltendem Abgang. Leicht und mehrish, ideal zu Tapas, Meeresfrüchten oder solo. 13 % Vol, Trinktemperatur 8–10 °C.",
        "image": null,
    ...
    },
    {
        ...
        short_description: 'Halbtrocken, fruchtig, leicht und aromatisch.',
        long_description: 'Der PINK St. Laurent Rosé von Tina Pfaffmann aus der Pfalz präsentiert sich halbtrocken mit lebendigen Aromen von Rumtopf, Mon Cheri-Kirsche und wildem Beerenmus. Eine Restsüße von 11,7 g/l sowie eine feine Säurestruktur sorgen für ein ausgewogenes Mundgefühl und erfrischenden Abgang.',
        image: null,
