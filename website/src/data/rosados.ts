...
export const rosados: Wine[] = [
    
    {
        ...
        grape: 'Pinot Grigio',
        origin: 'Italien',
        shortDescription: 'Fruchtig, halbtrocken, frisch und leicht.',
        longDescription: 'Allure Pink Pinot Grigio ist ein halbtrockener, fruchtiger Roséwein mit zarten Noten von roten Beeren und einem Hauch von Zitrus. Am Gaumen zeigt er sich frisch und leicht, mit einer angenehmen Restsüße und einem harmonischen Abgang. Ideal als Aperitif oder zu leichten Gerichten.',
        image: null,
